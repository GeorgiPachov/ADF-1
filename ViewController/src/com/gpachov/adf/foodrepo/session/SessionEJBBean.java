...
@Stateful(name = "SessionEJB", mappedName = "Application1-ViewController-SessionEJB")
public class SessionEJBBean implements SessionEJB, SessionEJBLocal {
    ...
    public ProductEntries persistProductEntries(ProductEntries productEntries) {
        em.persist(productEntries);
    ...
    public Recipes persistRecipes(Recipes recipes) {
        em.persist(recipes);
        return recipes;
    }
